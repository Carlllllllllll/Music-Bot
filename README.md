...
All code in this project is authored by ZYX. Please do not use this code for any public usage, such as creating YouTube videos, Git repositories, etc., without my explicit permission.

/*

   MADE BY ZYX!! FEEL FREE TO USE ANY PART OF CODE
